    ...
    <Box>
      ...
      <Box className="mb-24">
        ...
        <Typography variant="body1" color="text.secondary" className="text-lg">
          Provide essential details about your product to help customers find and understand what you're selling
        </Typography>
      </Box>
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                fullWidth
                error={!!errors.name}
                helperText={errors?.name?.message || "Choose a clear, descriptive name that customers will search for"}
                InputProps={{
                  startAdornment: (
                    <FuseSvgIcon size={20} className="mr-8" color="action">
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                helperText={errors?.shortDescription?.message || "A catchy summary that appears in search results"}
                InputProps={{
                  startAdornment: (
                    <FuseSvgIcon size={20} className="mr-8 mt-8" color="action">
      ...
      >
        <CardContent>
          ...
          <Typography variant="body1" color="text.secondary" className="mb-24 text-base">
            ...
            render={({ field: { onChange, value } }) => (
              ...
              >
                ...
                <Select
                  ...
                  value={value || ""}
                  startAdornment={
                    <FuseSvgIcon size={20} className="ml-8 mr-4" color="action">
                ...
                <FormHelperText>
                  {errors?.tradehub?.message || "Select the trade hub where this product is available"}
                </FormHelperText>
              </FormControl>
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              ...
              >
                ...
                <FormHelperText>
                  {errors?.category?.message || "Choose the most relevant category for better discoverability"}
                </FormHelperText>
              </FormControl>
            )}
          />
      ...
      >
        <Box className="flex items-start gap-16">
          <FuseSvgIcon size={24} className="text-info mt-4">
            heroicons-outline:light-bulb
          </FuseSvgIcon>
          <Box>
            <Typography variant="h6" className="font-semibold mb-12 text-info text-lg">
