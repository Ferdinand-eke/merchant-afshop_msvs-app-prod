...
function ShippingTab() {
	...
	const packageVolume = length && breadth && height ? ((length * breadth * height) / 1000000).toFixed(4) : 0;
		...
		<Box>
				...
				<CardContent>
					...
					{length > 0 && breadth > 0 && height > 0 && (
						<Box className="mt-24 p-16 rounded-lg bg-blue-50 border border-blue-200">
							<Typography
								variant="subtitle2"
								className="font-semibold mb-12 text-blue-900 text-base"
							>
					...
					<Box className="grid grid-cols-1 md:grid-cols-2 gap-20">
						<Controller
							...
							render={({ field: { onChange, value } }) => (
								...
								>
									<InputLabel
										id="perUnitShippingWeight-label"
										sx={{ fontSize: '1rem' }}
									>
										Weight Unit
									</InputLabel>
					...
					{weight > 0 && dimensionalWeight > 0 && (
						...
						>
							...
							>
								...
								<br />• Actual Weight: <strong>{weight} kg</strong>
								<br />• Dimensional Weight: <strong>{dimensionalWeight} kg</strong>
							</Typography>
						</Alert>
					)}
				</CardContent>
			...
			>
				...
				<ul className="list-disc list-inside space-y-2 text-base">
					<li>
						<strong>Measure accurately:</strong> Use the outer dimensions of the package, not just the
						product
					</li>
					<li>
						<strong>Include packaging weight:</strong> Add the weight of boxes, bubble wrap, and padding
					</li>
					<li>
						<strong>Use dimensional weight:</strong> Carriers charge based on package size and weight
					</li>
					<li>
						<strong>Offer tracking:</strong> Always provide tracking information to reduce disputes
					</li>
					<li>
						<strong>Fast processing:</strong> Quick handling times improve customer satisfaction
					</li>
					<li>
						<strong>Proper packaging:</strong> Mark fragile items clearly to prevent damage
					</li>
				</ul>
			</Alert>
			...
			<Box className="mt-24 p-20 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200">
				<Box className="flex items-start gap-12">
					...
					<Box>
						<Typography
							variant="h6"
							className="font-semibold mb-12 text-blue-900 text-lg"
						>
