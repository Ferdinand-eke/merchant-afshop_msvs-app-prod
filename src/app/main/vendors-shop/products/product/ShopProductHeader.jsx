        ...
        <div className="flex items-center max-w-full">
          ...
          <div className="flex flex-col min-w-0 mx-16">
            ...
            <div className="flex items-center">
              ...
              >
                Sale of counterfeit or stolen goods are highly prohibited,
                please be compliant on authenticity. Thanks!
              </Typography>
            </div>
          </div>
        </div>
        ...
        {productId !== "new" ? (
          <>
            ...
            <Button
              ...
              color="secondary"
              disabled={
                _.isEmpty(dirtyFields) || !isValid || addNewProduct?.isLoading
              }
          ...
          <Button
            ...
            color="secondary"
            disabled={
              _.isEmpty(dirtyFields) || !isValid || updateProduct?.isLoading
            }
