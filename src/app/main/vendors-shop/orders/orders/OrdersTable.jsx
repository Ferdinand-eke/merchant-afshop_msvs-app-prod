...
function OrdersTable() {
	const { data: shopOrderItems, isLoading: shopOrderItemsIsLoading, isError } = useShopItemsInOrders();
	...
	if (isError) {
		return (
			...
			>
				<MerchantClientErrorPage message="	Error occured retrieving orders!" />
			</motion.div>
		);
	}
