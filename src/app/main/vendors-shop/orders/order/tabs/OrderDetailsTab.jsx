								...
								<tr>
									<td>
										<div className="flex items-center">
											<Avatar src={order?.order?.shippingAddress?.fullName.charAt(0)} />
							...
							{order?.order?.isPaid && (
								<>
									<TableRow>
										...
										<TableCell>{new Date(order?.order?.packedAt)?.toDateString()}</TableCell>
									</TableRow>

									<TableRow>
										<TableCell>
											<OrdersShipmentStatus isShipped={order?.order?.isShipped} />
										</TableCell>
										<TableCell>{new Date(order?.order?.shippedAt)?.toDateString()}</TableCell>
									</TableRow>
									...
									<TableRow>
										<TableCell>
											<OrdersDeliveryStatus isDelivered={order?.order?.isDelivered} />
										</TableCell>
