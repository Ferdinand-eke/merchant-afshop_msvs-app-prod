							...
							<div className="mt-96">
								...
								<div className="flex">
									...
									<Typography
										...
										color="text.secondary"
									>
										In honor of the above transaction with referrence {order?.order?._id}, We at
										Africanshops consider this Transaction as haven fulfilled the purpose for which
										it was intended and haven satisfied our consumers, duly consent the repatriation
										of funds to this merchant. Warmest Regards!..
									</Typography>
								</div>
							</div>
						)}
