...
import { Button, Chip, InputAdornment, MenuItem, Select, TextField, Typography } from '@mui/material';
				...
				{cartItems && cartItems?.length > 0 ? (
					cartItems?.map((item) => (
						...
						>
							...
							<div className="ml-auto font-medium">N{formatCurrency(item?.price * item?.quantity)}</div>
						</div>
					))
				) : (
