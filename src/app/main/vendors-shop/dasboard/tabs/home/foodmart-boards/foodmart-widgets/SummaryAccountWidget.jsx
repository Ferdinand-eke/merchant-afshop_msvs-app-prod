...
/**
 * The SummaryAccountWidget widget.
 */
...
function SummaryAccountWidget({shopData, isLoading}) {
	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			...
			>
				<span className="truncate">Earning:</span>
				<b className="px-8 text-sm">NGN {formatCurrency(shopData?.shopaccount?.accountbalance)}</b>
			</Typography>
		</Paper>
	);
}

export default memo(SummaryAccountWidget);
