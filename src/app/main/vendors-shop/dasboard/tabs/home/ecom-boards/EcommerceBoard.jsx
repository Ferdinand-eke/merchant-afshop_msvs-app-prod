  ...
  return (
    <>
      ...
      <motion.div variants={item}>
        {isShopLoading ? renderWidgetSkeleton() : (
          <SummaryWidget
      ...
      <motion.div variants={item}>
        {isProductsLoading ? renderWidgetSkeleton() : (
          <OverdueWidget
      ...
      <motion.div variants={item}>
        {isOrdersLoading ? renderWidgetSkeleton() : (
          <IssuesWidget
      ...
      <motion.div variants={item}>
        {isSealedOrdersLoading ? renderWidgetSkeleton() : (
          <FeaturesWidget
        ...
        >
          <Box className="text-center">
            <Box className="flex justify-center mb-16">
              ...
              >
                <FuseSvgIcon className="text-white" size={40}>
            ...
            <Typography variant="body1" color="text.secondary" className="mb-24 max-w-md mx-auto">
              Get deeper insights into your sales trends, customer behavior, and inventory performance with our upcoming analytics dashboard.
            </Typography>
            ...
            <Box className="flex flex-wrap justify-center gap-12">
              <Box className="flex items-center gap-8 bg-white/60 backdrop-blur-sm rounded-xl px-16 py-8">
                <FuseSvgIcon className="text-orange-600" size={20}>
