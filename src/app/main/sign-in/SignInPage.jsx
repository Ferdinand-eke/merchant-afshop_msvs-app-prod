							...
							<Box className="flex items-start gap-12">
								...
								<div>
									...
									>
										...
										<span className="font-bold">AfricanShops Merchants Portal</span>. By signing in,
			...
			>
				...
				<div className="relative z-10 w-full max-w-2xl">
					...
					>
						...
						{/* Subtitle */}
						<Typography
							className="text-18 leading-relaxed mb-32"
							sx={{ color: 'rgba(255, 255, 255, 0.95)' }}
						>
							Manage your business with powerful tools designed for African merchants. Scale your
							operations, track sales, and grow your customer base with our comprehensive merchant
							dashboard.
						</Typography>
						...
						>
							<Typography
								className="text-14 font-bold mb-16"
								sx={{ color: 'white' }}
							>
							...
							<Box className="grid grid-cols-3 gap-16">
								{[
									...
									>
										<Typography
											className="text-28 font-black mb-4"
											sx={{ color: 'white' }}
										>
											{stat.value}
										</Typography>
						...
						>
							...
							>
								<Typography
									className="text-14 italic leading-relaxed mb-12"
									sx={{ color: 'white' }}
								>
