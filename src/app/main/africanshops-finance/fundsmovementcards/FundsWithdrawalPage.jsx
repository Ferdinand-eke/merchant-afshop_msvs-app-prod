...
function FundsWithdrawalPage(props) {
	...
	function handleWithdrawFunds() {
		...
		if (getValues()?.accountpin.toString().length > 4 || getValues()?.accountpin.toString().length < 4) {
				...
				<div className="flex flex-auto flex-col px-12 py-40 sm:px-6 sm:pb-80 sm:pt-72">
					...
					!shopAccount?.data?.afshopAccountPin ? (
						<>
							...
							>
								You are required to provide details fo your local banc and a 4 digit pin that should be
								kept personal for authorization .
							</Typography>
							<Timeline
								className="py-32"
								position="right"
						...
						<>
							...
							<Typography
								...
								color="text.secondary"
							>
								You can withraw your funds from merchant wallet to your locan band accounts.
							</Typography>
							<Timeline
								className="py-32"
								position="right"
