import { MenuItem, Select, FormControl, InputLabel, Paper, Typography, Box, Divider, Switch, FormControlLabel, Alert } from "@mui/material";
    ...
    <div>
      ...
      >
        <Box className="mb-24">
          <Typography variant="h6" className="font-bold mb-8" sx={{ color: '#ea580c' }}>
            <FuseSvgIcon size={24} className="mr-8">heroicons-outline:currency-dollar</FuseSvgIcon>
      ...
      >
        <Box className="flex items-center gap-12 mb-16">
          ...
          >
            <FuseSvgIcon className="text-white" size={20}>heroicons-outline:cash</FuseSvgIcon>
          </Box>
      ...
      >
        <Box className="flex items-center justify-between mb-16">
          <Box className="flex items-center gap-12">
            ...
            >
              <FuseSvgIcon className="text-white" size={20}>heroicons-outline:calculator</FuseSvgIcon>
            </Box>
            <Box>
              <Typography variant="h6" className="font-semibold">
                VAT & Tax Management
          ...
          >
            ...
            <Box className="space-y-12">
              ...
              <Box className="flex justify-between items-center">
                ...
                <Typography variant="body1" className="font-semibold" sx={{ color: '#10b981' }}>
      ...
      >
        <Box className="flex items-center gap-12 mb-16">
          ...
          >
            <FuseSvgIcon className="text-white" size={20}>heroicons-outline:plus-circle</FuseSvgIcon>
          </Box>
          <Typography variant="h6" className="font-semibold">
            Additional Fees
          </Typography>
      ...
      >
        <Box className="flex items-center gap-12 mb-16">
          ...
          >
            <FuseSvgIcon className="text-white" size={20}>heroicons-outline:home</FuseSvgIcon>
          </Box>
          <Typography variant="h6" className="font-semibold">
            Rental Options
          </Typography>
      ...
      >
        <Box className="flex items-center gap-12 mb-16">
          ...
          >
            <FuseSvgIcon className="text-white" size={20}>heroicons-outline:chart-bar</FuseSvgIcon>
          </Box>
        ...
        <Box className="space-y-12 mb-16">
          ...
          <Box className="flex justify-between items-center">
            ...
            <Typography variant="body1" className="font-semibold opacity-80">
