		...
		<Box>
			...
			>
				<Box className="flex items-center gap-12 mb-24">
					...
					<Typography
						variant="h6"
						sx={{ fontWeight: 700, color: '#292524' }}
					>
						Property Details
					</Typography>
				</Box>
				...
				<Controller
					...
					render={({ field: { onChange, value } }) => (
						...
						>
							...
							{errors?.propertyState && <FormHelperText>{errors.propertyState.message}</FormHelperText>}
						</FormControl>
					)}
				/>
				...
				<Controller
					...
					render={({ field: { onChange, value } }) => (
						...
						>
							...
							{errors?.propertyLga && <FormHelperText>{errors.propertyLga.message}</FormHelperText>}
						</FormControl>
					)}
				/>
			</Paper>
