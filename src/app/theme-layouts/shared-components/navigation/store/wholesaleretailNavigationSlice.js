...
export const wholesaleretailNavigationSlice = createSlice({
...
rootReducer.inject(wholesaleretailNavigationSlice);
wholesaleretailNavigationSlice.injectInto(rootReducer);
export const { setNavigation, resetNavigation } = wholesaleretailNavigationSlice.actions;
...
export default wholesaleretailNavigationSlice.reducer;
