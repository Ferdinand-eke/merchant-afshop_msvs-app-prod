/**
 * ManufacturersNavigationV2 — MANUFACTURERS plan navigation (v2 copy)
 *
 * Isolated copy of ManufacturersNavigation.jsx for use by PlanNavigationResolver.
...
function ManufacturersNavigationV2(props) {
...
export default withSlices([manufacturersNavigationSlice])(ManufacturersNavigationV2);
