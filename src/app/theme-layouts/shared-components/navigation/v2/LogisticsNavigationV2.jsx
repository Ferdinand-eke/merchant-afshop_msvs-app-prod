/**
 * LogisticsNavigationV2 — LOGISTICS plan navigation (v2 copy)
 *
 * Isolated copy of LogisticsNavigation.jsx for use by PlanNavigationResolver.
...
function LogisticsNavigationV2(props) {
...
export default withSlices([logisticsNavigationSlice])(LogisticsNavigationV2);
