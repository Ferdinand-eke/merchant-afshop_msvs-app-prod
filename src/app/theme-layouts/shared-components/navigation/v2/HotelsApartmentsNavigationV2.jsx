/**
 * HotelsApartmentsNavigationV2 — HOTELSANDAPARTMENTS plan navigation (v2 copy)
 *
 * Isolated copy of HotelsApartmentsNavigation.jsx for use by PlanNavigationResolver.
...
function HotelsApartmentsNavigationV2(props) {
...
export default withSlices([bookingsNavigationSlice])(HotelsApartmentsNavigationV2);
