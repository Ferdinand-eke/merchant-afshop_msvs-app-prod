...
import {
	getMerchantFoodOrdersApi,
	merchantDeliverFoodOrdersApi,
	merchantGetFoodOrderByIdApi,
	merchantGetFoodOrderItemsInFoodOrderById,
	merchantPackFoodOrders,
	merchantShipFoodOrders
...
export function useMerchantFindSingleFoodOrder(orderId) {
	return useQuery(['__merchant_foodorders', orderId], () => merchantGetFoodOrderByIdApi(orderId));
}
...
export function useGetMerchantFoodOrderItems(orderId) {
	return useQuery(['foodorders_items', orderId], () => merchantGetFoodOrderItemsInFoodOrderById(orderId));
}
