 ...
 *
 * @param {string} title - The title to display while loading (default: "Loading Dashboard...")
 * @param {string} subtitle - The subtitle to display while loading (default: "Preparing your merchant experience")
